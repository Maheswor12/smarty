<?php /* Smarty version Smarty-3.0.8, created on 2019-03-13 12:13:33
         compiled from "templates/admin/members.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2937992995c88e5ddb7c653-09663843%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e00165da958157594403675c1556ff0b41724e8a' => 
    array (
      0 => 'templates/admin/members.tpl',
      1 => 1552475611,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2937992995c88e5ddb7c653-09663843',
  'function' => 
  array (
  ),
...
<form action="member.php" method="post">
         ...
         <?php if ($_smarty_tpl->getVariable('id')->value!=0){?>
            <input type="hidden" name="members_id" value="<?php echo $_smarty_tpl->getVariable('user')->value['members_id'];?>
">
          <?php }?>
    ...
    <div class="form-group">
      ...
      <input type="text" value="<?php if (isset($_smarty_tpl->getVariable('_REQUEST',null,true,false)->value['edit'])){?><?php echo $_smarty_tpl->getVariable('user')->value['firstname'];?>
<?php }?>" class="form-control" name="firstname" id="" aria-describedby="emailHelpId" placeholder="Please Enter First Name" required>
    ...
    <button type="submit" class="btn btn-primary"><?php if ($_smarty_tpl->getVariable('id')->value!=0){?>Update<?php }else{ ?>Create<?php }?></button>
    </form>
...
?>
  <tr>
    ...
    <td><?php echo $_smarty_tpl->getVariable('users')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['firstname'];?>
</td>
    ...
    <td><a href="member.php?del=<?php echo $_smarty_tpl->getVariable('users')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['members_id'];?>
" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a> |
     <a href="member.php?edit=<?php echo $_smarty_tpl->getVariable('users')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['members_id'];?>
">Edit</a></td>
   </tr>
   <?php endfor; endif; ?>
 </table>
